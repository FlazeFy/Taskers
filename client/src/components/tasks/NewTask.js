...
const NewTask = () => {
    ...
    return (
        <div className='modal fade' id='new_task_modal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                    ...
                    <div className='modal-body position-relative px-3 py-4'>
                        ...
                        <form>
                            <div className="form-floating mb-3">
                                <input type="text" className="form-control px-3" id="floatingInput"></input>
                                <label for="floatingInput" className='px-3'> Task Title</label>
                            </div>
                            <div className="form-floating mb-3">
                                <textarea type="text" className="form-control px-3" id="floatingInput"></textarea>
                                <label for="floatingInput" className='px-3'> Description <span className='position-absolute input-info-desc'>Optional</span></label>
                            </div>
                            <div className="form-floating mb-3 position-relative">
                                <input type="text" className="form-control px-3" id="floatingInput"></input>
                                <label for="floatingInput" className='px-3'> Prize/Result <span className='position-absolute input-info-price'>Optional</span></label>
                            </div>
                                ...
                                <div className='row'>
                                    <div className='col-10'>
                                        <div className="form-floating mb-2">
                                            <input type="text" className="form-control px-3" id="floatingInput"></input>
                                            <label for="floatingInput" className='px-3'><b>#1</b> Checklist Name</label>
                                        </div>
                                    </div>
                                ...
                                <div className='row'>
                                    <div className='col-10'>
                                        <div className="form-floating mb-2 position-relative">
                                            <input type="text" className="form-control px-4" id="floatingInput"></input>
                                            <label for="floatingInput" className='px-3'>Tag Name</label>
                        ...
                        <button type='button' className='btn btn-success float-end' title='Save Task'><FontAwesomeIcon icon="fa-solid fa-add" /> Save</button>
                    </div>
                </div>
            </div>
        </div>
